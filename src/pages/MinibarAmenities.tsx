      ...
      <div className="flex justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Gestão de pedidos e controle de inventário</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-8">
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-lg font-bold text-slate-800">Pedidos de Reposição</h2>
            <Button onClick={() => setIsNewOpen(true)} className="gap-2 bg-slate-900 text-white">
