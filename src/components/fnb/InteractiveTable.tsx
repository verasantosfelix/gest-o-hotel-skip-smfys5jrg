...
export function InteractiveTable({ table, isEditMode, onUpdate, onClick }: InteractiveTableProps) {
  ...
  // Sync state from props when NOT interacting
  useEffect(() => {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isEditMode
          ? 'cursor-move ring-offset-2 hover:ring-2 ring-slate-300'
